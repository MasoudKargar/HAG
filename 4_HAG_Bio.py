...
if __name__ == "__main__":
    ...
    # Biological entities
    hag.add_edge("GeneA", "ProteinX", "expresses")
    hag.add_edge("ProteinX", "Pathway1", "activates")
    hag.add_edge("ProteinX", "ProteinY", "binds_to")
    hag.add_edge("ProteinY", "Pathway2", "inhibits")
    hag.add_edge("ProteinY", "ProteinZ", "phosphorylates")

    # Hierarchical biological abstraction
    hag.add_hyper_vertex("Module_CellSignal", {"ProteinX", "ProteinY"})
    hag.add_hyper_vertex("System_Response", {"Module_CellSignal", "Pathway1", "Pathway2"})

    # Display summary
    print(hag)

    # Visualize
    hag.draw(save_as="bio_hag.png")
    hag.draw_interactive(filename="bio_hag.html")
